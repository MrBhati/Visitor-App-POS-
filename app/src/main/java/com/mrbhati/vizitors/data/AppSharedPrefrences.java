...
public class AppSharedPrefrences 
{
	...
	public  void setBQREnabled(boolean status)
	{
		Editor edit = getSharePreferencesInstance().edit();
		edit.putBoolean("bqrstatus", status);
		edit.commit();
	}
	...
	public  void setBQRIdsEnabled(boolean status)
	{
		Editor edit = getSharePreferencesInstance().edit();
		edit.putBoolean("bqridsstatus", status);
		edit.commit();
	}
	...
	{
		Editor edit = getSharePreferencesInstance().edit();
		edit.putBoolean("paybylink", payByLink);
		edit.commit();
	}
	...
	public  void setVirtualPaymentId(String custCode)
	{
		Editor edit = getSharePreferencesInstance().edit();
		edit.putString("virtualpaymentid", custCode);
		edit.commit();
	}
	...
	{
		String custCode = getSharePreferencesInstance().getString("virtualpaymentid", "");
		return custCode;
	}
	...
	public void setWisepadUSBMode(boolean mode) {

		Editor edit = getSharePreferencesInstance().edit();
		edit.putBoolean("WisepadUSBMode", mode);
		edit.commit();
	}
